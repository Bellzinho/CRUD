        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php
                    // Puxar a configuração do banco
                    require_once "config.php";
                    
                    // Attempt select query execution
                    $sql = "SELECT * FROM employees";// <- MySQL query
                    if($result = mysqli_query($link, $sql)){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='read.php?id=". $row['id'] ."' title='Ver funcionário' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
                        ...
                        echo "ERRO: Imposivel de executar $sql. " . mysqli_error($link);
                    }
